...
# Data OrderKuota
MERCHANT_ID = "OK2269881"
API_KEY = "https://api.luxz-store.biz.id/api/orkut/createpayment?apikey=&amount=&codeqr="
CODE_QR = "00020101021126670016COM.NOBUBANK.WWW01189360050300000879140214528299364191270303UMI51440014ID.CO.QRIS.WWW0215ID20253753823270303UMI5204481253033605802ID5928SAYYID CELL JAKBAR OK22698816013JAKARTA BARAT61051110062070703A01630438E0"

# API URL
API_URL = f"https://gateway.okeconnect.com/api/mutasi/qris/{MERCHANT_ID}/{API_KEY}"

# ID Telegram Owner
OWNER_ID = [6999502050]  # Ganti dengan ID Owner Telegram kamu
